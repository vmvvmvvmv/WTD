...
class Users(AbstractBaseUser, PermissionsMixin):
    ...
    salt = models.CharField(db_column='SALT', max_length=60, blank=True)
...
class Info(models.Model):
    ...
    profile_image = models.ImageField(db_column='PROFILE_IMAGE', upload_to='profiles/', blank=True, null=True)
    #추가
    def __str__(self):
        return f"{self.region} - {self.diseases}"
